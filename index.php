...
use config\Project;
$project = new Project();
$projects = $project->getAllProjects(); // Načítanie všetkých projektov z databázy
?>
    <body>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="projects-thumb">
                                        <div class="projects-info">
                                            ...
                                            <h3 class="projects-title"><?= htmlspecialchars($proj['title']); ?></h3>
                                            <p><?= htmlspecialchars($proj['description']); ?></p>
                                        </div>

                                        <?php if (!empty($proj['image'])): ?>
                                            <a href="<?= htmlspecialchars($proj['image']); ?>" class="popup-image">
                                                <img src="<?= htmlspecialchars($proj['image']); ?>" class="projects-image img-fluid" alt="<?= htmlspecialchars($proj['title']); ?>">
                                            </a>
                                        <?php else: ?>
